...
def movie_dao():
    ...
    movie_2 = Movie(id=3, title="Second Movie", description="Description", trailer="link", year=2000, rating=10.0, genre_id=1, director_id=1)
    movie_3 = Movie(id=1, title="Third Movie", description="Description", trailer="link", year=2000, rating=10.0, genre_id=1, director_id=1)
